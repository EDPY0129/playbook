// El objetivo de este ejercicio es  usar los métodos viston en los ejemplos, for each, map, every, etc. segun lo que se pida, se trabajará con el siguiente areglo que contiene objetos. 
const explorers = [
    {
      name: "Explorer 1",
...
let newA = explorers.filter(Element => Element.stack.includes("js")) // aquí se valida que elementos del pbjetp tiene la palabra Js en la propiedad estck, esto se guarada en un nuevo arreglo
let newAr = []
